...
@property (strong, nonatomic) IBOutlet JSQMessagesCollectionView *collectionView;
...
- (void)viewDidLoad
{
    ...
    self.collectionView = [[JSQMessagesCollectionView alloc] initWithFrame:[UIScreen mainScreen].bounds
